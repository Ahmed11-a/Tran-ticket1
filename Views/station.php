            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Add or Update , Delete station</li>
                    </ol>
                    <div class="card mb-4">
                        <div class="card-body">
                            This page is for adding stations, their addresses and prices for categories
                        </div>
                    </div>
                    <button class="btn btn-primary my-2"><a href="add_station.php" class="text-light">Add Station</a></button>
                    <div class="card mb-4">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="Update_station.php?id= <?php echo $row['id']; ?> " class="btn btn-primary">Update</a>
                                                    <a href="deleteS.php?id= <?php echo $row['id']; ?> " class="btn btn-danger">delete</a>
                                                </td>
                                            </tr>
                                    <?php
                                        }
