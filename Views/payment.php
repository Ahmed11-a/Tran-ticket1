<?php
include('connect.php');
if (isset($_POST['submit']) && isset($_POST['pay'])) { //&& isset($_POST['trip']) && isset($_POST['Price'])) {
    $pay = $_POST['pay'];
    $cardN = $_POST['cardN'];
    $Name = $_POST['Name'];
    $tripN = $_POST['trip'];
    ...
    $email = $_POST['email'];
    $CVV = $_POST['CVV'];
    $sql = "select * from stationdb where id='$tripN' and (firstC='$price' or secondC='$price')";
    $result = mysqli_query($conn, $sql);
    $row = mysqli_fetch_assoc($result);
    if (isset($row['id']) == $tripN && (isset($row['firstC']) == $price or isset($row['secondC']) == $price)) {
        $sq = "insert into payment(pay ,cardN ,Name ,tripN ,price ,ExD, CVV ,email) 
                      values('$pay' ,'$cardN' ,'$Name' ,'$tripN' ,'$price' ,'$ExD', '$CVV', '$email')";
        $res = mysqli_query($conn, $sq);
        if ($res) {
            echo '<script> alert("Success to Payment ") </script>';
        } else {
...
//$tripN = stripcslashes('tripN');
//$price = stripcslashes('price');

//$result = "SELECT * FROM payment WHERE tripN = '$tripN' and price = '$price'" or die("Failed");
//$row = mysqli_fetch_assoc($result);
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <link href="styleOfPayment.css" rel="stylesheet">
...
<body>
    <div class="container">
        ...
        <div class="row">
                    ...
                    <div class="accordion" id="accordionPayment">
                        ...
                        <div class="accordion-item mb-3 border">
                            <h2 class="h5 px-4 py-3 accordion-header d-flex justify-content-between align-items-center">
                                <div class="form-check w-100 collapsed" data-bs-toggle="collapse" data-bs-target="#collapsePP" aria-expanded="false">
                                    <label class="form-check-label pt-1" for="payment2">
                                        <input class="form-check-input" type="radio" name="pay" value="PayPal">
                                        PayPal
                                    </label>
                                </div>
                                <span>
                            ...
                            <h2 class="h5 px-4 py-3 accordion-header d-flex justify-content-between align-items-center">
                                <div class="form-check w-100 collapsed" data-bs-toggle="collapse" data-bs-target="#collapsePP" aria-expanded="false">
                                    <label class="form-check-label pt-1" for="payment2">
                                        <input class="form-check-input" type="radio" name="pay" value="Credit Card">
                                        Credit Card
                            ...
                            <div id="collapsePP" class="accordion-collapse collapse" data-bs-parent="#accordionPayment">
                                <div class="accordion-body">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="" name="cardN">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="px-2 col-lg-6 mb-3">
                                        <label class="form-label">Number of trip</label>
                                        <input class="form-control" name="trip">
                                    </div>
                                    <div class="px-2 col-lg-6 mb-3">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="MM/YY" name="ExD">
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="mb-3">
            ...
            <button type="submit" value="submit" name="submit" class="btn btn-primary w-60 mt-2">Payment</button>
